...
public class WorkProjectLittleService {
    ...
    public Page<@NonNull WorkLittleFull> getWorkFull(Integer page, Integer size, List<String> sort, Integer stageZiGe, Integer stageZiLe, String task, Long projectId, List<WorkLittle> workLittleList) {
