...
//todo добавить разбивку по проектам
        ...
        works.forEach(workRepDto -> {
            ...
            sb.append("</td>");
            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getRelease()));
            sb.append("</td>");
            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getAnaliseEndPlanStr()));
            sb.append("</td>");
            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getAnaliseEndFactStr()));
            sb.append("</td>");
            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getLaborAnalise()));
            sb.append("</td>");
            sb.append(getTegStart("td", workRepDto.getLaborAnalise(), workRepDto.getTimeAnalise()));
            sb.append(printNotNull(workRepDto.getTimeAnalise()));
            sb.append("</td>");
            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getStartTaskPlanStr()));
            sb.append("</td>");
            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getStartTaskFactStr()));
            sb.append("</td>");

            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getLaborDevelop()));
            sb.append("</td>");
            sb.append(getTegStart("td", workRepDto.getLaborDevelop(), workRepDto.getTimeDevelop()));
            sb.append(printNotNull(workRepDto.getTimeDevelop()));
            sb.append("</td>");
            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getDevelopEndPlanStr()));
            sb.append("</td>");
            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getDevelopEndFactStr()));
            sb.append("</td>");
            sb.append(getTegStart("td", "table_col2"));
            sb.append(printNotNull(workRepDto.getIssuePrototypePlanStr()));
            sb.append("</td>");
            sb.append(getTegStart("td", "table_col2"));
            sb.append(printNotNull(workRepDto.getIssuePrototypeFactStr()));
            sb.append("</td>");

            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getDebugEndPlanStr()));
            sb.append("</td>");
            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getDebugEndFactStr()));
            sb.append("</td>");

            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getLaborDebug()));
            sb.append("</td>");
            sb.append(getTegStart("td", workRepDto.getLaborDebug(), workRepDto.getTimeDebug()));
            sb.append(printNotNull(workRepDto.getTimeDebug()));
            sb.append("</td>");
            sb.append(getTegStart("td", "table_col1"));
            sb.append(printNotNull(workRepDto.getIssuingReleasePlanStr()));
            sb.append("</td>");
            sb.append(getTegStart("td", "table_col1"));
            sb.append(printNotNull(workRepDto.getIssuingReleaseFactStr()));
            sb.append("</td>");
            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getReleaseEndPlanStr()));
            sb.append("</td>");
            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getReleaseEndFactStr()));
            sb.append("</td>");

            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getLaborRelease()));
            sb.append("</td>");
            sb.append(getTegStart("td", workRepDto.getLaborRelease(), workRepDto.getTimeRelease()));
            sb.append(printNotNull(workRepDto.getTimeRelease()));
            sb.append("</td>");
            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getOpeEndPlanStr()));
            sb.append("</td>");
            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getOpeEndFactStr()));
            sb.append("</td>");
            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getLaborOPE()));
            sb.append("</td>");
            sb.append(getTegStart("td", workRepDto.getLaborOPE(), workRepDto.getTimeOPE()));
            sb.append(printNotNull(workRepDto.getTimeOPE()));
            sb.append("</td>");
            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getTimePlan()));
            sb.append("</td>");
            sb.append(getTegStart("td", workRepDto.getTimePlan(), workRepDto.getTimeFact()));
            sb.append(printNotNull(workRepDto.getTimeFact()));
            sb.append("</td>");

            sb.append(getTegStart("td"));
            sb.append(printNotNull(workRepDto.getTimeWender()));
            sb.append("</td>");
