...
public class RU_Days extends DefaultDays {
    ...
    public void init() {
        ...
        add("2025-05-02", DayType.HOLIDAY,"с субботы 4 января на пятницу 2 мая");
        add("2025-12-31", DayType.HOLIDAY,"с воскресенья 5 января на среду 31 декабря;");
        add("2025-05-08", DayType.HOLIDAY,"с воскресенья 23 февраля на четверг 8 мая");
        add("2025-06-13", DayType.HOLIDAY,"с субботы 8 марта на пятницу 13 июня;");
        add("2025-11-03", DayType.WORKDAY,"с субботы 1 ноября на понедельник 3 ноября");
        add("2025-11-03", DayType.HOLIDAY,"с субботы 1 ноября на понедельник 3 ноября");
