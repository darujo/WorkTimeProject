...
public class UserWorkPeriodDto extends WeekWorkDto implements Serializable {
    ...
    public UserWorkPeriodDto(WeekWorkDto weekWorkDto, List<WorkTimeDto> list) {
        this(weekWorkDto.getDayStart(), weekWorkDto.getDayEnd(), weekWorkDto.getTime(), list);
    }

    public UserWorkPeriodDto(Timestamp dayStart, Timestamp dayEnd, Float time, List<WorkTimeDto> list) {
