...
public enum MessageType {
    ...
    AVAIL_WORK_LAST_DAY("Работы отмеченые вами за предыдущий рабочий день. Рассылается по рабочитм дняи в 11 часов"),
    AVAIL_WORK_LAST_WEEK("Работы отмеченые вами за предыдущей неделю. Рассылается в 12 на второй рабочий день."),
